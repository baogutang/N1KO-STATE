...
// N1KO's single AppSettings authority and source-level Settings integration.
...
struct MascotSettingsView: View {
    ...
    private var headerSection: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            HStack(spacing: 10) {
                StatChip(title: "客户端", value: "\(MascotClient.allCases.count)")
                StatChip(title: "已自定义", value: "\(settings.customizedMascotClientCount)")
