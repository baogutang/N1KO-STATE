...
enum NotchIndicatorTone: Equatable {
    ...
    var petPalette: NotchPetPalette {
        ...
        case .codebuddy:
            return NotchPetPalette(
                primary: Color(red: 0.80, green: 0.63, blue: 1.00),
                secondary: Color(red: 0.73, green: 0.53, blue: 0.98),
                accent: Color(red: 0.63, green: 0.41, blue: 0.95),
                shade: Color(red: 0.48, green: 0.28, blue: 0.78),
                detail: Color(red: 0.29, green: 0.16, blue: 0.52),
                highlight: Color(red: 0.94, green: 0.89, blue: 1.00),
                feature: Color(red: 0.85, green: 0.72, blue: 1.00),
                glow: TerminalColors.codebuddy,
                outerGlow: Color(red: 0.52, green: 0.29, blue: 0.82)
            )
        case .codex:
            return NotchPetPalette(
