...
// N1KO product identity and single-owner integration.
...
enum ClientProfileRegistry {
    nonisolated static let managedHookProfiles: [ManagedHookClientProfile] = [
        ManagedHookClientProfile(
            id: "claude-hooks",
            title: "Claude Code",
            subtitle: "管理 ~/.claude/settings.json，使用统一 N1KO Agent Bridge hooks 入口",
        ...
        ManagedHookClientProfile(
            id: "hermes-hooks",
            title: "Hermes",
            subtitle: "管理 ~/.hermes/plugins/n1ko_state，按 Hermes 官方 plugin hooks 协议接入 Island",
            installationKind: .pluginDirectory,
            alwaysVisibleInSettings: true,
            logoAssetName: "HermesLogo",
            prefersBundledLogoOverAppIcon: true,
            iconSymbolName: "paperplane.circle.fill",
            configurationRelativePath: ".hermes/plugins/n1ko_state",
            bridgeSource: "claude",
            bridgeExtraArguments: [
                "--client-kind", "hermes",
                "--client-name", "Hermes",
        ...
        ManagedHookClientProfile(
            id: "pi-hooks",
            title: "Pi Agent",
            subtitle: "管理 ~/.pi/agent/extensions/n1ko_state，按 Pi 官方 extension 机制接入 Island",
            installationKind: .pluginDirectory,
            alwaysVisibleInSettings: true,
            logoAssetName: "PiLogo",
            prefersBundledLogoOverAppIcon: true,
            iconSymbolName: "terminal.fill",
            configurationRelativePath: ".pi/agent/extensions/n1ko_state",
            bridgeSource: "claude",
            bridgeExtraArguments: [
                "--client-kind", "pi",
        ...
        ManagedHookClientProfile(
            id: "openclaw-hooks",
            title: "OpenClaw",
            subtitle: "管理 ~/.openclaw/hooks/n1ko-state，并自动启用内部 hook",
            ...
            activationEntryName: "n1ko-state",
            bridgeSource: "claude",
            bridgeExtraArguments: [
        ...
        ManagedHookClientProfile(
            id: "opencode-hooks",
            title: "OpenCode",
            subtitle: "管理 ~/.config/opencode/plugins/n1ko-state.js，按 OpenCode 官方插件 hooks 接入 Island",
    ...
    nonisolated static let ideExtensionProfiles: [ManagedIDEExtensionProfile] = [
        ManagedIDEExtensionProfile(
            id: "vscode-extension",
            title: "VS Code",
            subtitle: "安装 N1KO-STATE，支持终端精准聚焦",
        ...
        ManagedIDEExtensionProfile(
            id: "qoder-extension",
            title: "Qoder",
            subtitle: "安装 N1KO-STATE，支持会话跳转与终端精准聚焦",
            logoAssetName: "QoderLogo",
            prefersBundledLogoOverAppIcon: true,
