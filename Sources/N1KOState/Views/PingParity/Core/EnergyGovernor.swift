...
struct EnergyPolicy: Equatable {
    let codexThreadListRefreshInterval: TimeInterval?
    let sessionMaintenanceInterval: TimeInterval?
    ...
    static func policy(for mode: EnergyMode) -> EnergyPolicy {
        ...
        case .active:
            EnergyPolicy(
                codexThreadListRefreshInterval: 15,
                sessionMaintenanceInterval: 60,
        ...
        case .idleVisible:
            EnergyPolicy(
                codexThreadListRefreshInterval: 60,
                sessionMaintenanceInterval: 5 * 60,
                usageRefreshInterval: 5 * 60,
        ...
        case .quietBackground:
            EnergyPolicy(
                codexThreadListRefreshInterval: 5 * 60,
                sessionMaintenanceInterval: 10 * 60,
                usageRefreshInterval: 15 * 60,
        ...
        case .wakeGrace:
            EnergyPolicy(
                codexThreadListRefreshInterval: 30,
                sessionMaintenanceInterval: 60,
                usageRefreshInterval: 5 * 60,
                animationLevel: .reduced,
                eventMonitoringLevel: .interactionOnly,
