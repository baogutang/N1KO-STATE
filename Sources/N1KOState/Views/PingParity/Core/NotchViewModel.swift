...
class NotchViewModel: ObservableObject {
    ...
    private var compactDetachedSize: CGSize {
        if AppSettings.shared.notchDisplayMode == .detailed {
            return closedSize
        }
    ...
    private var maximumOpenedHeight: CGFloat {
        let maxPanelHeight = CGFloat(AppSettings.shared.maxPanelHeight)
    ...
    init(
        ...
        hideInFullscreenProvider: @escaping @MainActor () -> Bool = { AppSettings.shared.hideInFullscreen },
        fullscreenBrowserHiddenProvider: @escaping @MainActor (CGRect) -> Bool = FullscreenAppDetector.isFullscreenBrowserActive,
        autoHideWhenIdleProvider: @escaping @MainActor () -> Bool = { AppSettings.shared.autoHideWhenIdle },
    ...
    private func handleMouseMove(_ location: CGPoint) {
        ...
        if Self.shouldAutoCollapseHoverPreview(
            ...
            autoCollapseOnLeave: AppSettings.shared.autoCollapseOnLeave
        ) {
            notchClose()
        }
